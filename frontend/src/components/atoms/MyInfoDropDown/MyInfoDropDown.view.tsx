...
const MyInfoDropDownView = ({
    ...
    return (
        <section
            className={`text-text flex w-[15.5rem] origin-top transform flex-col rounded-sm border border-gray-200 bg-white p-1 text-sm leading-normal font-semibold transition-all duration-200 ease-out ${
                active
