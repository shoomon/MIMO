...
// userDepositDetails *
export const getUserDepositDetailAPI = async (): Promise<AccountDetailsResponse[]> => {
...
// userChargeDetails *
export const getUserChargeDetailAPI = async (): Promise<AccountDetailsResponse[]> => {
...
// userTransferDetails *
export const getUserTransferDetailAPI = async (): Promise<AccountDetailsResponse[]> => {
...
// userPayDetails *
export const getUserPayDetailsAPI = async (): Promise<AccountDetailsResponse[]> => {
...
// userAllDetails *
export const getUserAllDetailsAPI = async (): Promise<AccountDetailsResponse[]> => {
